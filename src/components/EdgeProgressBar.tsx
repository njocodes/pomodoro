...
export default function EdgeProgressBar({ progress, theme, isCompleted = false }: EdgeProgressBarProps) {
  const progressColor = theme === 'light' ? '#f3f4f6' : '#ffffff'; // Light mode: light gray for filled, Dark mode: white for filled
  const backgroundColor = theme === 'light' ? '#111827' : '#000000'; // Light mode: dark for unfilled, Dark mode: black
